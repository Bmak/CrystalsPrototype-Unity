...
[ExecuteInEditMode]
[AddComponentMenu("2DxFX/Standard/GrayScale_NGUI")]
[System.Serializable]
public class _2dxFX_GrayScale_NGUI : MonoBehaviour
{
	...
	void Awake()
	{
		if (this.gameObject.GetComponent<UI2DSprite>() != null) {
			_sprite2D = this.gameObject.GetComponent<UI2DSprite>();
		}
	}
	...
	void Update()
	{
		...
		if ((ShaderChange == 0) && (ForceMaterial != null)) {
			...
			} else if (this.gameObject.GetComponent<UI2DSprite>() != null) {
				_sprite2D.material = ForceMaterial;
			}
		...
		if ((ForceMaterial == null) && (ShaderChange == 1)) {
			...
			if (this.gameObject.GetComponent<SpriteRenderer>() != null) {
				...
				_sprite2D.material = tempMaterial;
			}
			ShaderChange = 0;
		}
		...
		if (ActiveChange) {
			if (this.gameObject.GetComponent<SpriteRenderer>() != null) {
				...
				_sprite2D.material.SetFloat("_Alpha", 1 - _Alpha);
				_sprite2D.material.SetFloat("_EffectAmount", _EffectAmount);

				if (_sprite2D.panel != null) {
					_sprite2D.panel.RebuildAllDrawCalls();
				}
			}			
		}		
	}
		...
		if ((Application.isPlaying == false) && (Application.isEditor == true)) {
			...
			if (gameObject.activeSelf && defaultMaterial != null) {
				if (this.gameObject.GetComponent<SpriteRenderer>() != null) {
					...
					_sprite2D.material = defaultMaterial;
					_sprite2D.material.hideFlags = HideFlags.None;
				}
			}	
		}
	}
...
#if UNITY_EDITOR
[CustomEditor(typeof(_2dxFX_GrayScale_NGUI)),CanEditMultipleObjects]
public class _2dxFX_GrayScale_NGUI_Editor : Editor
{
	...
	public override void OnInspectorGUI()
	{
		...
		_2dxFX_GrayScale_NGUI _2dxScript = (_2dxFX_GrayScale_NGUI)target;
